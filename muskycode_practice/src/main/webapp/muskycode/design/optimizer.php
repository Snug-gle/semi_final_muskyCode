    ...
    if (m) {
        ...
        n.report = function() {
            ...
            function v(g, a, b, c, d) {
                if (F)
                    n.computeStackTrace.augmentStackTraceWithInitialElement(F, a, b, g),
                    A();
                else if (d) {
            ...
            var z = [], C = null, F = null, E, G, I, e;
            y.subscribe = function(g) {
                !0 !== G && (E = m.onerror,
                m.onerror = v,
                G = !0);
                !0 !== e && (I = m.onunhandledrejection,
                m.onunhandledrejection = B,
                e = !0);
                z.push(g)
            }
            ;
            y.unsubscribe = function(g) {
                for (var a = z.length - 1; 0 <= a; --a)
                    z[a] === g && z.splice(a, 1);
                0 === z.length && (G && (m.onerror = E,
                G = !1),
                e && (m.onunhandledrejection = I,
                e = !1))
            }
            ;
            return y
        ...
        n.computeStackTrace = function() {
            ...
            function y(a) {
                return A(a).replace("<", "(?:<|&lt;)").replace(">", "(?:>|&gt;)").replace("&", "(?:&|&amp;)").replace('"', '(?:"|&quot;)').replace(/\s+/g, "\\s+")
            }
            function z(a, b) {
            ...
            function F(a) {
                if (!K(m && m.document)) {
                    ...
                    (c = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(a)) ? (d = c[1] ? "\\s+" + c[1] : "",
                    f = c[2].split(",").join("\\s*,\\s*"),
                    c = A(c[3]).replace(/;$/, ";?"),
                    d = new RegExp("function" + d + "\\s*\\(\\s*" + f + "\\s*\\)\\s*{\\s*" + c + "\\s*}")) : d = new RegExp(A(a).replace(/\s+/g, "\\s+"));
                    if (d = z(d, b))
                        return d;
            ...
            function E(a) {
                if (!a.stack)
                    return null;
                for (var b = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, c = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, d = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, f, q = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, p = /\((\S*)(?::(\d+))(?::(\d+))\)/, k = a.stack.split("\n"), r = [], l, h, x = /^(.*) is undefined$/.exec(a.message), w = 0, t = k.length; w < t; ++w) {
                    if (h = b.exec(k[w])) {
                        var M = h[2] && 0 === h[2].indexOf("native");
                        (f = h[2] && 0 === h[2].indexOf("eval")) && (l = p.exec(h[2])) && (h[2] = l[1],
                        h[3] = l[2],
                        h[4] = l[3]);
                        f = {
                            url: M ? null : h[2],
                        ...
                        (f = h[3] && -1 < h[3].indexOf(" > eval")) && (l = q.exec(h[3])) ? (h[3] = l[1],
                        h[4] = l[2],
                        h[5] = null) : 0 !== w || h[5] || K(a.columnNumber) || (r[0].column = a.columnNumber + 1),
                        f = {
                            url: h[3],
                            func: h[1] || "?",
                            args: h[2] ? h[2].split(",") : [],
            ...
            function I(a, b) {
                for (var c = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, d = [], f = {}, q = !1, p, k, r, l = I.caller; l && !q; l = l.caller)
                    if (l !== e && l !== n.report) {
                        k = {
                            url: null,
                            func: "?",
            ...
            function e(a, b) {
                ...
                try {
                    ...
                    if (4 > h.length)
                        ...
                        var w;
                        for (t in x)
                            Object.prototype.hasOwnProperty.call(x, t) && !x[t].src && d.push(x[t]);
        ...
        if (!n.linesOfContext || 1 > n.linesOfContext)
            n.linesOfContext = 11;
        "function" === typeof define && define.amd ? define("TraceKit", [], n) : "undefined" !== typeof module && module.exports && m.module !== module ? module.exports = n : m.TraceKit = n
    }
}
...
var EC_JET = function() {
    ...
    var D = {
        ...
        return K = e + y("path") + "?" + Object.keys(g).map(function(a) {
        ...
        for (var g = [], a = e.length, b, c = 0; c < a; c++)
            b = e[c],
            "string" === typeof b ? g.push(b.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : b && b.source && g.push(b.source);
        ...
        try {
            if (5 <= u.length)
                ...
                if (f = !0 !== c) {
                    var q;
                    (q = !0 !== g) || (q = !0 !== (0 === Object.keys(v).length || !1 === v.hasOwnProperty("error") || !1 === v.hasOwnProperty("time") ? !1 : 500 > Date.now() - v.time && v.error.message === e.message ? !0 : !1));
                    f = q
                }
                if (f) {
                    var p;
                    if (p = !0 === g && !0 === y("preventDuplicateReport")) {
                        ...
                        for (var l = k.length; l; )
                            a = 33 * a ^ k.charCodeAt(--l);
                        var h = r + (a >>> 0);
                        if (null != sessionStorage.getItem(h) && sessionStorage.getItem(h).trim() === k.trim())
                            var x = !0;
                        else
                            sessionStorage.setItem(h, k),
                            x = !1;
                        p = !0 === x
                    }
                    if (!p) {
                        ...
                        var t = window.navigator.languages ? window.navigator.languages[0] : window.navigator.userLanguage || window.navigator.language;
                        var M = {
                            locale: t,
        ...
        if (!0 !== L) {
            ...
            "withCredentials"in b ? (b.open("POST", a, !0),
            b.timeout = y("timeout", 500),
            b.onreadystatechange = function() {
                if (b.readyState === XMLHttpRequest.DONE) {
                    var c = b.status;
                    -1 !== [429, 500].indexOf(c) ? (E("xhr", a, g),
                    H = !1,
                    L = !0,
                    m.report.unsubscribe(C)) : 200 !== c && E("xhr", a, g)
                }
            }
            ,
            b.send(g)) : (e = new Image,
    ...
    return {
        init: function(e, g) {
            if ("string" !== typeof e || "object" !== typeof g)
        ...
        message: function(e, g) {
            if (!1 !== H && e) {
                if (I(e))
                    var a = m.computeStackTrace(e);
                else
                    a = m.computeStackTrace.ofCaller(),
                    a.message = "string" === typeof e ? e : JSON.stringify(e);
                C(a, !1, null, g)
            }
        }
    }

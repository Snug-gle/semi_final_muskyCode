...
#idCheck:hover, #postSearch:hover {
	...
	<br>
		<div>
		<form name="joinForm" id="join" action="<%=request.getContextPath() %>/muskycode/index.jsp?muskygroup=member&musky=join_action" method="post">
				...
				<div class="join_write_form">
					<ul>
						<li>
							...
							<div id="idRegMsg" class="error">아이디는 영문자로 시작되는 영문자,숫자로 6~20범위의 문자로만 작성 가능합니다.</div>
		...
		<h3>전체 동의</h3>
			<div class="tos_all">
		        <p>
		        <span class="ec-base-chk"><input type="checkbox" id="sAgreeAllChecked" name="allCheck"><em class="checkbox"></em></span>
		        <label for="sAgreeAllChecked"><strong>이용약관 및 개인정보수집 및 이용에 모두 동의합니다.</strong></label>
		        </p>
		    </div>
		...
		<span class="tos">
	        ...
	        <div class="content">
	            <div class="tos_1">
	            <p> 제1조(목적)<br>
	           		이 약관은 <span style='color: rgb(0, 0, 0); font-family: "Comic Sans MS"; font-size: 12px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;'>(주)에이케이인터내셔널</span>
					회사(전자상거래 사업자)가 운영하는 MUSKI MUSKY 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br>
					...
					회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버 몰을 운영하는 사업자의 의미로도 사용합니다.<br>② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.<br>
					...
					① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 MUSKI MUSKY 사이버 몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
	        ...
	        <p class="check"><span>이용약관에 동의하십니까?<br><br></span>
	        	<input id="agree_service_check0" name="agreeCheck" fw-filter="/1/" fw-label="이용약관 동의" fw-msg="이용약관에 동의 하세요" class="ec-base-chk" value="1" type="checkbox"  />
		...
		<span class="tos">
		    ...
		    <br><br><input id="agree_privacy_check0" name="agreeCheck" fw-filter="/1/" fw-label="개인정보 수집 및 이용 방침" fw-msg="개인정보 수집 및 이용 방침에 동의하세요" class="ec-base-chk" value="1" type="checkbox"  />
		    <label for="agree_privacy_check0" >동의함</label>
		    </p>
		</span>
		
		<div class="submitMsg" style="color: red; display: none;">약관에 모두 동의하였는지 확인해주세요.</div>
		
		<div class="join_finish">
			<button type="submit" class="btn_black">회원가입</button>  
...
var serviceAgree = document.getElementById("agree_service_check0");
var privacyAgree = document.getElementById("agree_privacy_check0");

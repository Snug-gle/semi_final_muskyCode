...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 글번호를 전달받아 REVIEW 테이블에 저장된 해당 글번호의 게시글을 검색하여 클라이언트에게 전달하는 JSP 문서 --%>
<%-- => [글삭제]를 클릭한 경우 게시글 삭제페이지(REVIEW_remove_action.jsp)로 이동 - 글번호 전달 --%>    
<%-- => [글변경]를 클릭한 경우 게시글 변경값 입력페이지(REVIEW_modify.jsp)로 이동 - 글번호 전달 --%>    
<%-- => [답글쓰기]를 클릭한 경우 게시글 입력페이지(REVIEW_write.jsp)로 이동 - 부모글 관련 정보 전달 --%>    
<%-- => [글목록]를 클릭한 경우 게시글 목록 출력페이지(REVIEW_list.jsp)로 이동 - 검색 관련 정보 전달 --%>    
<%
	...
	//글번호를 전달받아 REVIEW 테이블에 저장된 해당 글번호의 게시글에 조회수를 증가하는 DAO 클래스의 메소드 호출
	ReviewDAO.getDAO().updateHit(num);
...
<div id="container" style="position: relative; bottom:100px; width: 1000px;">
				...
				<div class="ec-base-table typeWrite ">
					<table border="1" summary="">
						...
						<tbody>
							<tr>
								<th scope="row">제목</th>
								<td  style="text-align: left; text-indent: 20px;"><%=review.getRTITLE() %>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<strong style="text-align: right;">작성일</strong>&nbsp;<%=review.getRDATE()%>&nbsp;&nbsp;&nbsp;&nbsp;
										<strong>조회수</strong>&nbsp;<%=review.getRHIT()+1 %>
								</td>
							</tr>
							<tr>
								<th scope="row">작성자</th>
								<td  style="text-align: left; text-indent: 20px;"><%=review.getMID() %> </td>
							</tr>
							<tr>
								<th scope="row">이미지</th>
								<td  style="text-align: left; text-indent: 20px;">
								<img src="<%=request.getContextPath() %>/muskycode/board/review_images/<%=review.getRIMGURL() %>">
								</td>
							</tr>
							<tr>
									...
									<div class="detail">
										<div class="fr-view fr-view-article">
											<p style="margin: 0px; padding: 0px; box-sizing: border-box; font-family: NanumSquare, sans-serif; letter-spacing: -0.5px; display: block; line-height: 1.5; color: rgb(51, 51, 51); font-size: 15px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; orphans: 2; text-align: start; text-indent: 20px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">
												<span style="font-size: 12px;"><%=review.getRCONTENT().replace("\n", "<br>") %></span>
											</p>
										</div>
									</div>
								</td>
	...
	<div id="qna_menu">
		...
		<% if(loginMember!=null && (loginMember.getMID().equals(review.getMID()) 
	...
	<form id="boardForm" method="post">
		<%-- [글삭제]와 [글변경]을 클릭한경우 요청 JSP 문서에 전달되는 값 --%>
...
$("#removeBtn").click(function() {
	if(confirm("게시글을 삭제 하시겠습니까?")) {
		$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=board&musky=review_remove_action");
		$("#boardForm").submit();
	}
});

$("#modifyBtn").click(function() {
	$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=board&musky=review_modify");
	$("#boardForm").submit();
});

$("#replyBtn").click(function() {
	$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=board&musky=review_write");
	$("#boardForm").submit();
});

$("#listBtn").click(function() {
	$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=board&musky=review");
	$("#boardForm").submit();
});
</script>

...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 글번호를 전달받아 QNA 테이블에 저장된 해당 글번호의 게시글을 검색하여 입력태그의 초기값으로 
...
<div id="AllForm">
<form action="<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=board&musky=qna_modify_action"
	...
	<table>
			<tr>
				<th>제목</th>
				 <td>
				<input type="text" id="subject" name="qtitle" size="40" value="<%=qna.getQTITLE()%>">
				</td> 
			</tr>
			<tr>
				<th>내용</th>
				<td>
					<textarea rows="7" cols="60" name="qcontent" id="qcontent"><%=qna.getQCONTENT() %></textarea>
				</td>
			</tr>
			<tr>
				<th colspan="2">

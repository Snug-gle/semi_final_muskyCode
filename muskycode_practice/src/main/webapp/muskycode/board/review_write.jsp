...
<div id="AllForm">
	<form action="<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=board&musky=review_write_action"
	 method="post" enctype="multipart/form-data" id="reviewForm">
		...
		<table>
			<tr>
				<th>상품이름</th>
				<td>
					<input type="text" name = "pname"readonly="readonly" value="<%=ProductDAO.getDAO().selectNumProduct(pno).getPNAME()%>">
				</td>
			</tr>
			<tr>
				<th>제목</th>
				 <td>
					<input type="text" name="rtitle" id="rtitle" size="40">
				</td> 
			</tr>
			<tr>
				<th>이미지</th>

...
<%
	...
	MemberDTO loginMember = (MemberDTO)session.getAttribute("loginMember");
	 ...
	 int count;
	 if(loginMember!=null) {
	 	count = CartDAO.getDAO().selectCountCart(loginMember.getMID());  
	 } else {
		count = 0;
	 }
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/muskycode/design/swiper.min.css" />
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/muskycode/design/froala_style_ec.min.css" charset="utf-8" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/muskycode/design/optimizerd7b0.css?filename=nZBBCkIxEEP3xa3nCHoEj-ANpnXUD-2kTKegt9edbgTpNuTlQXBnUxyOju68uTS4Dk4vijIGrk4LFLZG272DPf7pa0mDdcZGS5mPRXBGrEqrPNXX0JBcdRFlT3UzTVnMfvqld5wofsH5e-7z8Qs&amp;type=css&amp;k=a052fbc291df183c9caddf6aefc2c6be24ab00a6&amp;t=1635315871" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/muskycode/design/optimizer87c7.css?filename=tdVLbgMhDAbgfei253ArJVGP0EUXlXoCxuMMbgEjDHncvuTRLqruAqthYPRh_TIMOAkEhKYqZYVPjtv1Zrt5eoFUJ89oXAkedCYzk_ISQb84Pq8BVSHIXD2BtyepBdAWWiSfHtrSI3RjQ_WF1Ul6Yy2dbSWb0b2SnSn3olNuT_yxzU5yuIu-lTpZZbzsgxKCxL7mdaKvSbhqL7SqPMYtIq0z0hjckR8k3_pjEG4Xju0cDkrcTmPgqZbSu6V_bTkOS8MPCrp9hnfJBzoPDIckufQ64f9ccpIKS3zPtGc6dK44k7dnfUzEbaHfnf_3V_XhOCWOS2cfJe4b0TJJl_b4Bg&amp;type=css&amp;k=faa19c5b2f2b5f3dc7661027f8e072a4cdad707d&amp;t=1625719215&amp;user=T" />


<div style="width: 100%; height: 40px; background-color: #252525; position: fixed; top: 0; z-index: 9999; font-size: 15px;">
	<a href="#" style="color: #fff; display: inline-block; width: 100%; text-align: center; line-height: 39px;">
		MuskiMusky 신규 회원가입 시 적립금 2,000원 지급</a>
</div>
			...
			<div class="cate_section">
				<div class="contents">
					...
					<div class="logo_section">
						<div class="logo_show" style="display:inline-block; width: 70%; height: 50px;">
							<a href="<%=request.getContextPath()%>/muskycode/index.jsp"><img
								src="<%=request.getContextPath()%>/muskycode/images/logo.ver1.png" alt="" /></a>
						</div>
					</div>
					<div class="leftCategory">
						<div id="category"
							...
							<ul class="position">
								<li class="cate1"><a href="index.jsp?muskygroup=main&musky=intro" class="cateList">BRAND</a>
									<div
										class="xans-element- xans-layout xans-layout-boardinfo sub-category -hover">
										<ul>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=main&musky=intro">사이트 소개</a></li>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=main&musky=map">오시는 길</a></li>
										</ul>
									</div></li>
								<li class="cate1 xans-record-"><a href="index.jsp?muskygroup=product&musky=product_solid"
									class="cateList">PRODUCT</a>
									<div
										class="xans-element- xans-layout xans-layout-boardinfo sub-category -hover">
										<ul>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=product&musky=product_solid">SOLID</a></li>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=product&musky=product_body">BODY</a></li>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=product&musky=product_hair">HAIR</a></li>
										</ul>
									</div></li>
								<li class="cate1 top_board"><a href="index.jsp?muskygroup=notice&musky=notice_list"
									class="cateList">COMMUNITY</a>
									<div
										class="xans-element- xans-layout xans-layout-boardinfo sub-category -hover">
										<ul>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=notice&musky=notice_list">공지사항</a></li>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=board&musky=review">상품사용후기</a></li>
											<li class="xans-record-"><a
												href="index.jsp?muskygroup=board&musky=qna">상품 Q&A</a></li>
										</ul>
									</div>
								</li>
							</ul>
					...
					<div class="rightCategory">
						<div class="inner">
							...
							<div class="top_section">
								<div class="contents">
									<ul class="xans-element- xans-layout xans-layout-statelogoff right off ">
										<li class="category"><a href="#"><i
												class="xi-user-o"></i></a>
												<div class="sub-category -hover">
													<ul>
														<% if(loginMember==null) { %>
														<li><a href="index.jsp?muskygroup=member&musky=login">LOGIN</a></li>
														<li><a href="index.jsp?muskygroup=member&musky=join">JOIN</a></li>
														<li><a href="index.jsp?muskygroup=member&musky=login">ORDER</a></li>
														<li><a href="index.jsp?muskygroup=member&musky=login">MY PAGE</a></li>
														<% } else if(loginMember.getMGRADE()==1) { %>
														<li><a href="index.jsp?muskygroup=member&musky=logout_action">LOGOUT</a></li>
														<li><a href="index.jsp?muskygroup=mypage&musky=my_order">ORDER</a></li>
														<li><a href="index.jsp?muskygroup=mypage&musky=mypage">MY PAGE</a></li>
														<% } else if(loginMember.getMGRADE()==9) { %>
														<li><a href="index.jsp?muskygroup=member&musky=logout_action">LOGOUT</a></li>
														<li><a href="index.jsp?muskygroup=mypage&musky=my_order">ORDER</a></li>
														<li><a href="index.jsp?muskygroup=mypage&musky=mypage">MY PAGE</a></li>
														<li><a href="index.jsp?muskygroup=admin&musky=member_manage">MANAGER</a></li>
														<% } %>
													</ul>
												</div>
											</li>
										<li class="xans-element- xans-layout xans-layout-orderbasketcount ">
											<a href="index.jsp?muskygroup=cart&musky=cart_list"><i class="xi-cart-o"></i>
											<span class="count">
											<%=count%>
											</span></a>
										</li>
										<li><a class="search"><i class="xi-search"></i></a></li>
										<div class="searchWrap">
											<form id="searchBarForm" name="" method="post" target="_self"
											action="<%=request.getContextPath() %>/muskycode/index.jsp?muskygroup=product&musky=product_search" >
												<div class="xans-element- xans-layout xans-layout-searchheader ">
													<fieldset>
														<legend style="display: none;">검색</legend>
														<input id="keyword" name="keyword" class="inputTypeText" type="text" /> 
															<i alt="검색" onclick="searchClick()" class="xi-search"></i>
													</fieldset>
												</div>
											</form>
											<form id="searchForm" name="" method="get" target="_self" enctype="multipart/form-data"  >
												<div class="xans-element- xans-search xans-search-form ">
													<fieldset>
														<div class="xans-element- xans-search xans-search-hotkeyword popular">
														#DO SON　　　　#EAU ROSE　　　　#EAU CAPITALE
														</div>
													</fieldset>
												</div>
											</form>
...
function searchClick() {
	var kwd = $("#keyword").val();
	location.href = "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=product&musky=product_search&keyword="+kwd;
}

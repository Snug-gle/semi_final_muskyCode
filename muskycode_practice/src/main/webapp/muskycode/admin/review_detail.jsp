...
$("#removeBtn").click(function() {
	if(confirm("게시글을 삭제 하시겠습니까?")) {
		$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=admin&musky=review_remove_action");
		$("#boardForm").submit();
	}
});

$("#modifyBtn").click(function() {
	$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=admin&musky=review_modify");
	$("#boardForm").submit();
});

$("#replyBtn").click(function() {
	$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=admin&musky=review_write");
	$("#boardForm").submit();
});

$("#listBtn").click(function() {
	$("#boardForm").attr("action", "<%=request.getContextPath()%>/muskycode/index.jsp?muskygroup=admin&musky=review_manage");
	$("#boardForm").submit();
});
</script>
